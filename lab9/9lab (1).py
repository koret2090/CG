...
class CutterApp(QtWidgets.QMainWindow, design.Ui_MainWindow):
    ...
    def intersection(self, peak1, peak2, edge1, edge2):    
        ...
        return I
        '''
        coefficientMatrix = [[peak2.x() - peak1.x(), edge1.x() - edge2.x()],\
                                            [peak2.y() - peak1.y(), edge1.y() - edge2.y()]]

        matrixOfRightParts = [[edge1.x() - peak1.x()], 
                                              [edge1.y() - peak1.y()]] 
        
        coefficientMatrix[0][0], coefficientMatrix[1][1] = - coefficientMatrix[1][1], - coefficientMatrix[0][0]
        
        resParam = [[coefficientMatrix[0][0] * matrixOfRightParts[0][0] + coefficientMatrix[0][1] * matrixOfRightParts[1][0]],
                             [coefficientMatrix[1][0] * matrixOfRightParts[0][0] + coefficientMatrix[1][1] * matrixOfRightParts[1][0]]]
        t = resParam[1][0] / resParam[0][0]
        peakIntersection = QtCore.QPointF()
        peakIntersection.setX(peak1.x() + (peak2.x() - peak1.x()) * t)
        peakIntersection.setY(peak1.y() + (peak2.y() - peak1.y()) * t)
        
        return peakIntersection
        ''' 
