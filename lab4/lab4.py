...
class App(QtWidgets.QMainWindow, design.Ui_MainWindow):
    ...
    def lib_ellipse(self,  x_centre, y_centre, coef_a, coef_b):
        self.scene.addEllipse(x_centre - coef_a, y_centre - coef_b, 2 * coef_a, 2 * coef_b, self.pen)
    ...
    def mid_point_ellipse(self,  x_centre, y_centre, coef_a, coef_b):
        ...
        #p = coef_b_sqr - coef_a_sqr * coef_b + 0.25 * coef_a_sqr
